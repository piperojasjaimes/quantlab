//+------------------------------------------------------------------+
//| scalping_XAUUSD_H4_7b3e31.mq5
//| Generated by QuantLab — 2026-07-04T02:16:55.619912+00:00
//| Pattern: scalping | TF: H4 | Symbol: XAUUSD
//+------------------------------------------------------------------+
...
input int    InpStopLoss = 20;
input int    InpTakeProfit = 50;
input int    InpTrailingStop = 42;
...
void ExecuteStrategy() {
    ...
    if(emaFast[1] > emaSlow[1] && emaFast[0] > emaSlow[0]) {
        ...
        trade.Buy(InpLotSize, _Symbol, ask, sl, tp, "scalping_XAUUSD_H4_7b3e31_BUY");
    }
    if(emaFast[1] < emaSlow[1] && emaFast[0] < emaSlow[0]) {
        double sl = bid + InpStopLoss * _Point;
        double tp = bid - InpTakeProfit * _Point;
        trade.Sell(InpLotSize, _Symbol, bid, sl, tp, "scalping_XAUUSD_H4_7b3e31_SELL");
    }
}
