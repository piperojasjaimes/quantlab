//+------------------------------------------------------------------+
//| scalping_USDCAD_H4_cd7e12.mq5
//| Generated by QuantLab — 2026-07-04T02:11:39.398051+00:00
//| Pattern: scalping | TF: H4 | Symbol: USDCAD
//+------------------------------------------------------------------+
...
void ExecuteStrategy() {
    ...
    if(emaFast[1] > emaSlow[1] && emaFast[0] > emaSlow[0]) {
        ...
        trade.Buy(InpLotSize, _Symbol, ask, sl, tp, "scalping_USDCAD_H4_cd7e12_BUY");
    }
    if(emaFast[1] < emaSlow[1] && emaFast[0] < emaSlow[0]) {
        double sl = bid + InpStopLoss * _Point;
        double tp = bid - InpTakeProfit * _Point;
        trade.Sell(InpLotSize, _Symbol, bid, sl, tp, "scalping_USDCAD_H4_cd7e12_SELL");
    }
}
