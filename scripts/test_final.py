"""Test final EA with neutral filter."""
import sys, time
sys.path.insert(0, '.')
import numpy as np
...
print(f"Final EA: ${final:,.0f} | Trades: {m['total_trades']}")
print(f"WR: {m['win_rate']}% | PF: {m['profit_factor']} | DD: {m['max_drawdown_pct']}%")
print(f"Sharpe: {m['sharpe_ratio']} | Commission: ${m['total_commission']:,.0f}")
